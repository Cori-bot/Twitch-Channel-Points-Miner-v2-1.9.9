...
twitch_miner = TwitchChannelPointsMiner(
    username="Coridor___",
    password="Maeric83140",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1175466137056706581/DzYKqspgN8GtnW5oeYEb10rHmw1Cd2Zbq4Lzp6qLQckE58J-NmWQWCc_D2wpTMw3bqnB",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.DROP_CLAIM,Events.BONUS_CLAIM,
                    Events.GAIN_FOR_CLAIM,Events.GAIN_FOR_WATCH,
                    Events.GAIN_FOR_RAID,Events.GAIN_FOR_WATCH_STREAK],                                  # Only these events will be sent to the chat
        ),
        webhook=Webhook(
